...
interface TableProps {
    rawData: BookPayload[]
    handleSelectBook: (selectedBook: BookPayload) => void
}
const BookShelfTable: React.FC<TableProps> = ({ rawData, handleSelectBook }) => {
    return (
                    ...
                    {rawData.map((row) => (
                        ...
                        >
                            ...
                            <TableCell align="right">
                                <Button variant="contained" disabled={row.number_in_stock <= 0} onClick={() => handleSelectBook(row)} color="primary">เช่า</Button>
                            </TableCell>
                        </TableRow>
                    ))}
                </TableBody>
